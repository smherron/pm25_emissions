...
## Have total emissions from PM2.5 decreased in Baltimore City, MD (fips = "24510) 
## from 1999 to 2008? 
...
summary(baltimore)
by_year <- aggregate(Emissions ~ year, baltimore, sum)
...
with(by_year,
     barplot(height = (Emissions/10^6), names.arg = year,
             ...
             main = "Annual PM2.5 Totals In Baltimore City",
